...
def create_data_louvain_relabeled_graph(graph: nx.Graph, mapping_path: Path,  new_data: Path):
    log: Log = Pretty()
...
def create_data_louvain(graph: nx.Graph, new_data: Path, publications_till=2018, log_file='', log=Pretty()):
    louvain(graph, new_data, log)
